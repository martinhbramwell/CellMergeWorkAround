...
#    desc = 'A tool for writing a CSV file into a new/existing sheet in a spreadsheet.\nAn OAuth access token is required.'
    ...
    parser.add_argument("-ce", "--client_email", dest="client_email", required=True, help="This is the GMail account that will be used for SMTP communication with spreadsheet owners.")
    ...
    parser.add_argument("-cs", "--client_secret", dest="client_secret", required=True, help="The Client Secret you get from Google's API console.")

    parser.add_argument("-am", "--auth_method", dest="auth_method", required=True, help="Can be either 'ForDevices', 'InstalledApp' or 'ToBeDropped' (to edit storage to drop the connection between project and user)")
    ...
    parser.add_argument("-ru", "--args.redirect_uri", dest="redirect_uri", required=True, help="This is the Redirect URI you get from Google's API console.")
